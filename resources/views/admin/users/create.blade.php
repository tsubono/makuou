...
@section('title', '会員登録 | 会員管理 | 幕王管理画面')
            ...
            <form class="form-horizontal" action="{{ url('/admin/users') }}" method="post">
                ...
                <fieldset>
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="user-name" name="user[name]" value="{{ old('user.name') }}" class="form-control" required placeholder=""/>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->has('name_kana') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="user-name_kana" name="user[name_kana]" value="{{ old('user.name_kana') }}" class="form-control" required placeholder=""/>
                    ...
                    <div class="form-group {{ $errors->has('company_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="user-company_name" name="user[company_name]" value="{{ old('user.company_name') }}" class="form-control" placeholder=""/>
                    ...
                    <div class="form-group {{ $errors->has('address2') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="user-address2" name="user[address2]" value="{{ old('user.address2') }}" class="form-control" required placeholder="番地・ビル名"/>
                    ...
                    <div class="form-group {{ ($errors->has('tel01')||$errors->has('tel02')||$errors->has('tel03')) ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6 form-inline">
                            <input type="number" id="user-tel01" name="user[tel01]" class="form-control" value="{{ old('user.tel01') }}" required>
                            -
                            <input type="number" id="user-tel02" name="user[tel02]" class="form-control" value="{{ old('user.tel02') }}" required>
                            -
                            <input type="number" id="user-tel03" name="user[tel03]" class="form-control" value="{{ old('user.tel03') }}" required>
                            @if ($errors->has('tel01'))
                    ...
                    <div class="form-group {{ ($errors->has('fax01')||$errors->has('fax02')||$errors->has('fax03')) ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6 form-inline">
                            <input type="number" id="user-fax01" name="user[fax01]" class="form-control" value="{{ old('user.fax01') }}">
                            -
                            <input type="number" id="user-fax02" name="user[fax02]" class="form-control" value="{{ old('user.fax02') }}">
                            -
                            <input type="number" id="user-fax03" name="user[fax03]" class="form-control" value="{{ old('user.fax03') }}">
                            @if ($errors->has('fax01'))
                        ...
                        <div class="col-md-6">
                            <select id="user-gender" name="user[gender]" class="form-control">
                                ...
                                @foreach (config('const.gender') as $key => $gender)
                                    <option value="{{ $key }}" {{ old('user.gender') == $key ? "selected" : "" }}>{{ $gender }}</option>
                                @endforeach
                            </select>
