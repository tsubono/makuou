    ...
    <div class="wrap cf">
        <div class="left">
            <div class="cf">
                ...
                <div class="catch"><img src="{{asset("assets/img/common/head_catch.png")}}" alt="オリジナルの横断幕自分でデザイン気軽に発注"></div>
            </div>
        </div>
        <div class="right sp_none">
            ...
            <div class="hour">
                ...
                <div class="box_dot"><p>【営業時間】9:00～17:00　<span class="txt_blue">土</span><span class="txt_red">日祝</span>休み</p></div>
            </div>
        </div>
