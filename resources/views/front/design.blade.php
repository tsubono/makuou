    ...
    <div class="row justify-content-center">
        <div class="container ng-scope" ng-controller="ProductCtrl" ng-app="productApp" id="productApp">
            ...
            <div class="row clearfix clear" ng-cloak>
                <!-- 編集コントロール諸々 -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 editor_section"
                    ...
                    <div id="content" class="tabing">
                        ...
                        <ul id="tabs" class="nav nav-tabs design_modal" data-tabs="tabs">
                            ...
                            <li>
                                <a ng-click="deactivateAll()" href="#upload_own" class="graphics"
                                   aria-controls="upload_own"
                            ...
                            <li>
                                <a ng-click="deactivateAll()" href="#clip_arts" class="graphics"
                                   aria-controls="clip_arts"
                                   role="tab" data-toggle="tab">
                                ...
                                <div class="graphic_options clearfix">
                                    <ul>
                                        <li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 active">
                                            <div>
                                                <a href="#text_design" aria-controls="text_design" role="tab"
                                                   data-toggle="tab">
                    ...
                    <div class="col-lg-12 setting" ng-class="fabric.selectedObject ? 'activeControlsElem' : ''"
                        ...
                        <div class="well">
                            ...
                            <div class="row row-margin">
                                <div class="row col-lg-6" title="Font size"
                                     ng-show="fabric.selectedObject.type == 'text'">
                                    <!-- フォントサイズ入力 -->
                                    <md-input-container flex>
                                ...
                                <div class="row col-lg-6" title="Line height"
                                     ng-show="fabric.selectedObject.type == 'text'">
                                    <!-- 行間入力 -->
                                    <md-input-container flex>
                            ...
                            <div class='row form-group' ng-show="fabric.selectedObject.type == 'text'">
                                <md-button class="md-raised md-cornered"
                                           ...
                                           ng-click="fabric.selectedObject.textAlign = 'left'" aria-label="Align Left">
                                    <i
