        ...
        <div class="l-inner">
            <section class="sample">
                ...
                <div class="main__content">
                    ...
                    <p>下記フォームに内容を記入の上、画面下部の「確認する」を押して、登録確認にお進みください</p>
            ...
            <section class="pickup">
                ...
                <div class="btn"><a href="/search/"><img src="{{asset("assets/img/top/make_btn.png")}}" alt="ネットでレイアウトを調整しながら自分でデザイン！オリジナル横断幕を作る"></a></div>
            </section>
            <!-- /.pickup -->
        </div>
    </main>
