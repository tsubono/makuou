...
<main class="l-main">
    <div class="l-inner">
        <h1 class="main__title">
            <picture>
                <img src="../assets/img/example/title.png" srcset="../assets/img/example/title@2x.png 2x" alt="よくあるご質問">
            </picture>
        </h1>
        ...
        <div id="c001" class="modal__content">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <p class="modal__description">コメントコメントコメントコメントコメントコメントコメントコメントコメントコメントコメントコメントコメントコメントコメ ントコメントコメントコメントコメントコメントコメントコメントコメント</p>
                </figcaption>
            </figure>
        </div>
