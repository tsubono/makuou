...
<main class="l-main">
    <div class="l-inner">
        <h1 class="main__title">
            <picture>
                <img src="../assets/img/faq/title.png" srcset="../assets/img/faq/title@2x.png 2x" alt="よくあるご質問">
            </picture>
        </h1>
            ...
            <div class="faq">
                ...
                <section id="faq01" class="faq__section">
                    ...
                    <dl class="faq__list">
                        ...
                        <dt>やり方がわかりません。使いたいイラストも、コメントも、フォントも決まっています。使いたい写真も用意しました。レイアウトも決めました。手書きでイメージを送ります。デザインしてもらえますか。</dt>
                        ...
                        <dd>過去のデーターはマイページに保存されていますので、そちらから再注文可能です。マイページから見つからない場合でも、データーは保管されている場合があるので、ご相談ください。</dd>
                ...
                <section id="faq03" class="faq__section">
                    ...
                    <dl class="faq__list">
                        ...
                        <dt>校章や社章は使えますか。</dt>
                        <dd>ご利用者様ご自身で画像をアップロードして、オリジナルのロゴ等をデザインに追加できます。画像データーが無い場合は、写真等からデーターを作成することも出来ます（有料）ので、ご相談ください。</dd>
                        <dt>社名のロゴは使えますか。</dt>
                        <dd>ご利用者様ご自身で画像をアップロードして、オリジナルのロゴ等をデザインに追加できます。画像データーが無い場合は、写真等からデーターを作成することも出来ます（有料）ので、ご相談ください。</dd>
                    </dl>
                </section>
                ...
                <section id="faq04" class="faq__section">
                    ...
                    <dl class="faq__list">
                        ...
                        <dd>申し訳ありませんが、金色、銀色は印刷できません。かわりに黄色にグラデーション効果を組み合わせせるなどしてメタリック感を表現いたします。</dd>
                        <dt>塗り足しとは何ですか。</dt>
                        <dd>塗り足しとは、仕上がりのサイズよりも外にある、裏面に折り返される部分のことです。仕上げの縫製加工の都合により、塗り足しによって背景を拡大してデーターを作成してください。</dd>
                        ...
                        <dd>コンピューター上で使われる色であれば、どのような組み合わせでも再現できます。デザインでのお悩みであれば、経験豊富なデザイナーがお手伝いいたしますので、メールまたは電話にてご相談ください。</dd>
                    </dl>
                </section>
                <!-- /#faq04 -->
                ...
                <!-- /#faq06 -->
                <a class="faq__btn" href=""><img src="../assets/img/faq/btn--order.png" alt="ネットでレイアウトを調整しながら自分でデザイン！オリジナル横断幕を作る"></a>
            </div>
        </div>
    </div>
</main>
