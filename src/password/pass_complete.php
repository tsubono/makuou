...
<main class="l-main">
    <div class="l-inner">
            <section class="password pass_complete">
                <h1 class="main__title"><img src="../assets/img/password/ttl_pass_complete.png" alt="パスワードを変更いたしました"></h1>
                <div class="main__content">
                    ...
                    <div class="password__wrap">
                        ...
                        <p class="submit_btn"><input type="submit" value="ログインページへ"></p>
                    </div>
                </div>
            </section>
                <!-- /.search -->
