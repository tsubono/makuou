...
<main class="l-main">
    <div class="l-inner">
        <h1 class="main__title">
            <picture>
                <img src="../assets/img/search/title.png" srcset="../assets/img/search/title@2x.png 2x" alt="横断幕を作る">
            </picture>
        </h1>
        <div class="main__content">
            ...
            <section class="pickup">
                <h2 class="pickup__heading">
                    <picture>
                        <img src="../assets/img/search/heading--pickup.png" srcset="../assets/img/search/heading--pickup@2x.png 2x" alt="Pick Up!">
                    </picture>
                </h2>
