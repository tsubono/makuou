...
<main class="l-main">
    <div class="l-inner">
        <h1 class="main__title">
            <picture>
                <img src="../../assets/img/search/result/title.png" srcset="../../assets/img/search/result/title@2x.png 2x" alt="横断幕を作る">
            </picture>
        </h1>
        <div class="main__content">
            <ul class="main__breadcrumb">
                <li><a href="/">HOME</a></li>
                <li><a href="/search/">横断幕を作る</a></li>
                <li>検索結果</li>
            </ul>
            <div class="result">
                <div class="result__box">
                    <div>
                        ...
                        <img class="result__img" src="../../assets/img/banner/banner01.png" alt="">
                ...
                <div class="result__box">
                    <div>
                        <h2 class="result__title">タイトルが入ります</h2>
                        <img class="result__img" src="../../assets/img/banner/banner02.png" alt="">
                        <dl class="result__list">
                            <dt>テイスト</dt>
                            <dd>
                                <ul class="result__tags">
                ...
                <div class="result__box">
                    <div>
                        <h2 class="result__title">タイトルが入ります</h2>
                        <img class="result__img" src="../../assets/img/banner/banner03.png" alt="">
                        <dl class="result__list">
                            <dt>スポーツ</dt>
                            <dd>
                                <ul class="result__tags">
            ...
            <section class="search">
                <div class="search__inner">
                    <h2 class="search__heading">
                        <picture>
                            <img src="../../assets/img/search/heading--search.png" srcset="../../assets/img/search/heading--search@2x.png 2x" alt="テンプレートを探す">
                        </picture>
                    </h2>
